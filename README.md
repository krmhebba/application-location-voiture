...
* **Système de Location :** Louer une voiture : Création automatique d'un contrat, calcul du coût total en fonction de la durée et mise à jour immédiate de la disponibilité. Retourner une voiture : Remise en disponibilité du véhicule après la location.
* **Recherche et Tri :** Recherche de véhicules par marque. Algorithme de tri (Tri à bulles) pour afficher les offres par ordre croissant de prix.
